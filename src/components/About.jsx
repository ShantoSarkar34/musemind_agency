            ...
            <div className="about-title-content">
              ...
              <div className="pt-10 lg:pt-20 space-y-[25px] lg:space-y-[50px] lg:px-40">
                <p className="text-fourth font-normal text-[18px] md:text-[22px] lg:text-[24px] leading-[32px]">
                  Welcome to Musemind: Where UX Dreams Soar! As your dedicated
                  UX design agency, we transforms user insights into dynamic
                  strategies, collaborating with diverse industries and
                  expertise.{" "}
                </p>

                <p className="text-fourth font-normal text-[18px] md:text-[22px] lg:text-[24px] leading-[32px]">
                  Our experts utilize tech trends, shaping designs that surpass
                  expectations with innovation. Our meticulous process
                  guarantees pixel-perfect results for apps and websites. We are
                  partners, offering end-to-end excellence. Join Musemind and
                  see how extraordinary UX design can transform your business.
                  ‘‘Elevating UX’’ is more than just a tagline; it’s our
                  commitment to you.
                </p>
              </div>
            </div>
